...
namespace ICL.HoloLens.Unity
{
    ...
    public class StabilizationPlaneModifier : Singleton<StabilizationPlaneModifier>
    {
        ...
        private void ConfigureTransformOverridePlane(float deltaTime)
        {
            ...
            HolographicSettings.SetFocusPointForFrame(planePosition, -gazeManager.Normal, velocity);
        }
        ...
        private void ConfigureGazeManagerPlane(float deltaTime)
        {
            ...
            Vector3 gazeDirection = GazeManager.Instance.Normal;
            ...
            if (InteractibleManager.Instance.FocusedGameObject)
            {
                focusPointDistance = (gazeManager.GazeOrigin - GazeManager.Instance.Position).magnitude;
            }
            else
            {
        ...
        private void ConfigureFixedDistancePlane(float deltaTime)
        {
            ...
            planePosition = gazeManager.GazeOrigin + (gazeManager.Normal * currentPlaneDistance);
            HolographicSettings.SetFocusPointForFrame(planePosition, -gazeManager.Normal, Vector3.zero);
        }
        ...
        private void OnDrawGizmos()
        {
            ...
            {
                Vector3 focalPlaneNormal = -gazeManager.Normal;
